...
(function () {
    ...
    // sort filter show
    function hideSort() {
        var $sort = $(".sort_filters");
        var $backdrop = $(".backdrop-level-2");
    ...
    $("#sortby_trigger").click(function (e) {
    ...
    // close sort trigger
    $("#closeSortTrigger").click(function (e) {
        hideSort();
    });

    // Click anywhere on document to hide the panel
    $(document).click(function (e) {
        var $sort = $(".sort_filters");

        // If click is outside the sort div and trigger
        if (!$sort.is(e.target) && $sort.has(e.target).length === 0 &&
            !$("#sortby_trigger").is(e.target)) {
            hideSort();
        }
    });

    // Prevent clicks inside the panel from closing it
    $(".sort_filters").click(function (e) {
        e.stopPropagation();
    });
})();
